...
reg [15:0] memory [0:4095];		// Small memory to hold test code
...
//      $readmemh("src/Stump/first.hex", memory);
//      $display("Running first");
//      $readmemh("src/Stump/test1.hex", memory);
//      $display("Running test 1");
//      $readmemh("src/Stump/test2.hex", memory);
//      $display("Running test 2");
//      $readmemh("src/Stump/test3.hex", memory);
//      $display("Running test 3");
      $readmemh("src/Stump/test4.hex", memory);
