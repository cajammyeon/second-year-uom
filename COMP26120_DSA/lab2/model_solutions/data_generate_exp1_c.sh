...
do
    ...
    # Debugging statement to check program calls working as expected
        # ../../lab1/c/speller_darray -d dictionaries_and_queries/dict_${SIZE}_${STATE}_$COUNT -m 1 -s 100000 dictionaries_and_queries/single_query

    ALL_TIME=`(time -p  ../../lab1/c/speller_darray -d dictionaries_and_queries/dict_${SIZE}_${STATE}_$COUNT -m 1 -s 100000 dictionaries_and_queries/single_query) 2>&1 | grep -E "user|sys" | sed s/[a-z]//g`
