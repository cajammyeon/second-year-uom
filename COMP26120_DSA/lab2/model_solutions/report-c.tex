...
\label{fig:sorted1}
\end{figure}
\newcommand{\sortedoneq}{-0.003}
\newcommand{\sortedonem}{0.000001}
...
mq_value = sprintf("Parameters values\n100,000m = %f\nq = %f", m*100000, q)
set label 1 at 15000,4 mq_value
...
\newcommand{\sortedtwom}{0.00018 \times 10^{-5}}
