...
The lab manual details which files make up the solution of this exercise which you **have to** commit, tag for submission as `lab3_sol`, and then push both the commit and tag to your repo.
